...
const file_pb_ping_proto_rawDesc = "" +
	"\n" +
	"\rpb/ping.proto\x12\x02ws\"\r\n" +
	"\vPingRequest\",\n" +
	"\fPingResponse\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x03R\ttimestamp28\n" +
	"\vPingService\x12)\n" +
	"\x04Ping\x12\x0f.ws.PingRequest\x1a\x10.ws.PingResponseB/Z-github.com/filament-labs/filament/internal/pbb\x06proto3"
...
var file_pb_ping_proto_goTypes = []any{
	(*PingRequest)(nil),  // 0: ws.PingRequest
	(*PingResponse)(nil), // 1: ws.PingResponse
}
var file_pb_ping_proto_depIdxs = []int32{
	0, // 0: ws.PingService.Ping:input_type -> ws.PingRequest
	1, // 1: ws.PingService.Ping:output_type -> ws.PingResponse
