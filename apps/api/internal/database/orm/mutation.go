...
type AddressMutation struct {
	...
	typ           string
	id            *int
	_type         *pbv1.AddressType
	add_type      *pbv1.AddressType
	address       *string
...
func (m *AddressMutation) SetType(pt pbv1.AddressType) {
	m._type = &pt
	m.add_type = nil
}

// GetType returns the value of the "type" field in the mutation.
func (m *AddressMutation) GetType() (r pbv1.AddressType, exists bool) {
	v := m._type
	if v == nil {
		return
	}
...
func (m *AddressMutation) OldType(ctx context.Context) (v pbv1.AddressType, err error) {
...
// AddType adds pt to the "type" field.
func (m *AddressMutation) AddType(pt pbv1.AddressType) {
	if m.add_type != nil {
		*m.add_type += pt
	} else {
		m.add_type = &pt
...
func (m *AddressMutation) AddedType() (r pbv1.AddressType, exists bool) {
	v := m.add_type
	if v == nil {
		return
	}
...
func (m *AddressMutation) AddedEdges() []string {
	...
	if m.wallet != nil {
		edges = append(edges, address.EdgeWallet)
	}
	return edges
}
