...
func (_c *AddressCreate) SetType(v address.Type) *AddressCreate {
...
func (_c *AddressCreate) createSpec() (*Address, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(ormaddress.Table, sqlgraph.NewFieldSpec(ormaddress.FieldID, field.TypeInt))
	)
