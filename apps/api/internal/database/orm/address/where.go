...
func Type(v pbv1.AddressType) predicate.Address {
	vc := int32(v)
...
func TypeEQ(v pbv1.AddressType) predicate.Address {
	vc := int32(v)
	return predicate.Address(sql.FieldEQ(FieldType, vc))
}

// TypeNEQ applies the NEQ predicate on the "type" field.
func TypeNEQ(v pbv1.AddressType) predicate.Address {
	vc := int32(v)
	return predicate.Address(sql.FieldNEQ(FieldType, vc))
}

// TypeIn applies the In predicate on the "type" field.
func TypeIn(vs ...pbv1.AddressType) predicate.Address {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int32(vs[i])
	}
...
func TypeNotIn(vs ...pbv1.AddressType) predicate.Address {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = int32(vs[i])
	}
...
func TypeGT(v pbv1.AddressType) predicate.Address {
	vc := int32(v)
	return predicate.Address(sql.FieldGT(FieldType, vc))
}

// TypeGTE applies the GTE predicate on the "type" field.
func TypeGTE(v pbv1.AddressType) predicate.Address {
	vc := int32(v)
	return predicate.Address(sql.FieldGTE(FieldType, vc))
}

// TypeLT applies the LT predicate on the "type" field.
func TypeLT(v pbv1.AddressType) predicate.Address {
	vc := int32(v)
	return predicate.Address(sql.FieldLT(FieldType, vc))
}

// TypeLTE applies the LTE predicate on the "type" field.
func TypeLTE(v pbv1.AddressType) predicate.Address {
	vc := int32(v)
