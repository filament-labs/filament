...
func (_u *AddressUpdate) SetType(v pbv1.AddressType) *AddressUpdate {
...
func (_u *AddressUpdate) SetNillableType(v *pbv1.AddressType) *AddressUpdate {
	if v != nil {
		_u.SetType(*v)
	}
	return _u
...
func (_u *AddressUpdate) AddType(v pbv1.AddressType) *AddressUpdate {
...
func (_u *AddressUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedType(); ok {
		_spec.AddField(address.FieldType, field.TypeInt32, value)
	}
...
// SetType sets the "type" field.
func (_u *AddressUpdateOne) SetType(v pbv1.AddressType) *AddressUpdateOne {
	_u.mutation.ResetType()
	_u.mutation.SetType(v)
	return _u
}
...
// SetNillableType sets the "type" field if the given value is not nil.
func (_u *AddressUpdateOne) SetNillableType(v *pbv1.AddressType) *AddressUpdateOne {
	if v != nil {
		_u.SetType(*v)
	}
	return _u
...
// AddType adds value to the "type" field.
func (_u *AddressUpdateOne) AddType(v pbv1.AddressType) *AddressUpdateOne {
	_u.mutation.AddType(v)
	return _u
}
